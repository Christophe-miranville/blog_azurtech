...
class Article1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'La voiture 100% électrique, les VE !',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text(
                  'vous habitez en appartement et vous pensez que ce n\'est pas possible de faire insaller une prise ou une brine chez vous ?'),
              const Text(
              ...
              const Text(
                  'Pour une voiture possédant une batterie de 50Kw pour environ une autonomie de 400kms'),
